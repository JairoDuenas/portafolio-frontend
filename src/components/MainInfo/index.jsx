        ...
        <div className="col-md-8">
          <div className="card-body">
            ...
            <h4 className="card-text">
              <small className="text-muted">Desarrollador Web / Frontend</small>
            </h4>
            <p className="card-text">
              Gran capacidad de adaptabilidad al cambio, trabajo en equipo,
              buenas relaciones interpersonales, con iniciativa y creatividad en
              la búsqueda de soluciones, pensamiento estratégico, alto sentido
              de compromiso con las entidades y personas que intervienen en mi
              oficio.
            </p>
          </div>
        </div>
